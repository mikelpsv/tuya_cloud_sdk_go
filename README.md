...
В данном репозитории изменен механизм формирования подписи, который Tuya изменила, но не внесла изменения в sdk, поэтому он перестал работать (  
...
Получениее информации об устройстве, просто вызовите device.GetDevice () напрямую.
